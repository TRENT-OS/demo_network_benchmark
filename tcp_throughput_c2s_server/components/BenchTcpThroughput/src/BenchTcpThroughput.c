...
static OS_Error_t
recvTraffic(OS_Socket_Handle_t hSocket) {
    static uint8_t dataBuf[OS_DATAPORT_DEFAULT_SIZE];
    OS_Error_t ret;
...
run(void)
{
    Debug_LOG_INFO("Starting Bench TCP Throughput");
